      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="${pageContext.request.contextPath}/pages/cadastros/contatos/lista_contatos.jsp">Contatos</a>
            <a class="collapse-item" href="${pageContext.request.contextPath}/pages/utilities-border.html">Usuários</a>
          </div>
        </div>
      </li>
    </ul>