              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Realizar Cadastro</h1>
                  </div>
	                  <form class="user" action="${pageContext.request.contextPath}/CadastroControllerServlet" method="post" >
	                   
	                   <div class="form-group">
	                      <input type="text" class="form-control form-control-user" id="nome" 
	                      		aria-describedby="login" placeholder="Informe seu nome"
	                      		name="nome">
	                    </div>
	                    
	                    <div class="form-group">
	                      <input type="text" class="form-control form-control-user" id="sobrenome" 
	                      		aria-describedby="login" placeholder="Informe seu sobrenome"
	                      		name="sobrenome">
	                    </div>
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="login.jsp">Voltar</a>
                  </div>
                </div>
              </div>
            </div>
